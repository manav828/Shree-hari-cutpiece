...
export default async function BohemianShopPage({ searchParams }: ShopPageProps) {
  ...
  if (initialCategory !== "all") {
    ...
    const mappedProducts = !productsError && Array.isArray(productRows)
      ? mapRowsToListingProducts(productRows as unknown as ProductQueryRow[], selectedCategorySlug, selectedCategoryName)
      : [];
