...
export default function CartSidebar() {
  ...
  function handleUpsellQuickAdd(product: any) {
    addToCart({
      ...
      analytics_source: "luxury_quick_cart_upsell",
    });
  }
            ...
            <div className="space-y-6">
              ...
              {!upsellLoading && upsellProducts.length > 0 && (
                <div className="border-t border-border pt-6 mt-8">
                  <h4 className="font-serif tracking-wide text-lg text-foreground mb-4 italic">Complete the Look</h4>
                  <div className="grid grid-cols-2 gap-4">
                    {upsellProducts.map((upsell) => (
                      <div key={upsell.id} className="group">
                        <div className="aspect-[3/4] relative overflow-hidden bg-background-secondary mb-2 border border-border/40">
                          <Image
                        ...
                        <h5 className="font-medium tracking-wide text-xs text-foreground mb-1 line-clamp-1">
                          {upsell.name}
                        </h5>
                        ...
                        <button
                          ...
                          className="w-full py-2 border border-foreground/60 hover:border-foreground hover:bg-foreground hover:text-white transition-all duration-300 text-[10px] tracking-[0.15em] uppercase font-semibold"
                        >
                          Quick Add
                        </button>
                      </div>
