...
const DEFAULT_LANGUAGE: BlogVariant["language"] = "hi";
...
export default async function BlogDetailHindiPage({ params }: BlogDetailPageProps) {
    const post = await fetchPost(params.slug, DEFAULT_LANGUAGE);
    ...
    return (
        <>
            <Navbar />
            <CartSidebar />
            <main className="pt-12 lg:pt-24 pb-0 bg-background min-h-screen">
                <Container>
                    <nav className="mb-10">
