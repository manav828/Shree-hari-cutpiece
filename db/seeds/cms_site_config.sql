INSERT INTO public.site_config (key, value, label, "group", type) VALUES
  ...
  ('hero_desktop_image',  'https://images.unsplash.com/photo-1558171813-4c088753af8f?auto=format&fit=crop&w=2400&q=90', 'Desktop Hero Image', 'hero', 'url'),
  ('hero_mobile_image',   'https://images.pexels.com/photos/6069557/pexels-photo-6069557.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=1600', 'Mobile Hero Image',  'hero', 'url'),
